...
import { Removeemployee, Updateattendance } from "../../Redux/Emp/EmployeeSlice";
...
function EmployeeBox(props){
    ...
    function VerificationMode(props){
        async function handleyes(){
            ...
            const response = await fetch(`http://localhost:4000/employee/data?operation=update&empname=${Name}`,requestoption)
    ...
    return <>
    <div className="container my-3" style={add?{'borderLeft':'5px solid green'}:null} onClick={handleadd}>
        <div className="row">
            <div className="col-2">
                <img alt="man_image" src={gender==='Male'?man:woman} style={{'width':'30px','height':'30px'}}/>
            </div>  
    ...
    <VerificationMode show={verify} name={props.name} onHide={()=>setverify(false)}/>
    </>
}
