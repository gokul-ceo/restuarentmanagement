...
function Vendormodel(props){
  ...
  async function  handlesave (){
    ...
    const response = await fetch('http://localhost:4000/addvendor',requestoption);
    ...
    return (
        ...
        >
          ...
          <Modal.Body>
            ...
            <input id="vendorname" style={{"border":"none","outline":"none","borderBottom":"1px solid black","marginTop":"15px"}} onChange={handleinputchange} value={vendorname} type="text"/>
            <div class="form-check form-switch my-3">
            <input class="form-check-input" onChange={handletoggle} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
            <label class="form-check-label" for="flexSwitchCheckDefault">Balance</label>
            </div>
            {showbalance && <input class="form-control" type="Number" onChange={(e)=>{setbalance(e.target.value)}} value={balance} placeholder="Add balance.." aria-label="default input example"></input>}
